...
class Mesh():
    ...
    def __init__(self, root, obj, name="mesh", position="0 0 0", orientation="0. -1 0. 0.", velocity="0. 0. 0.", omega="0. 0. 0.", scale="1", st=None, pinned="false", magnetic="false", density="1", restitution=None, friction=None, color=None):
        # Fixed body
        self.body = general.body(root, "mesh", name, position, orientation, velocity=velocity, omega=omega, obj=obj, st=st, scale=scale, pinned=pinned, magnetic=magnetic, density=density, restitution=restitution, friction=friction, color=color)
