...
composite = Composite(root, obj=None, scale="2", name="funnel", position="0. 50. 0.", velocity="0. 0. 0.", color="0.5 0. 0. 1.")
composite.addBox(name='wall1', position="0. 0. -13.", orientation="-1 0 0 1.1", dim='48 22 1')
composite.addBox(name='wall3', position="0. 0. 13.", orientation="1 0 0 1.1", dim='48 22 1')
composite.addBox(name='wall2', position="-13. 0. 0.", orientation="0 0 1 1.1", dim='1 22 48')
composite.addBox(name='wall4', position="13. 0. 0.", orientation="0 0 -1 1.1", dim='1 22 48')
