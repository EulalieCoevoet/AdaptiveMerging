...
Box(root, name='box1', position="-3.75 "+spinnery+" 3.75", orientation="0 -1 0 0", dim="3 3 3", color="0. 0. 0.5 1.")
Box(root, name='box2', position="3.75 "+spinnery+" -3.75", orientation="0 -1 0 0", dim="3 3 3", color="0.8 0.8 0. 1.")
