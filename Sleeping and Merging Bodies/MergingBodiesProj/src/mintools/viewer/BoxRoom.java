...
public class BoxRoom implements SceneGraphNode {
    ...
    public void display( GLAutoDrawable drawable ) {
        ...
        if ( drawFloor.getValue () ) {
            ...
            gl.glColor4fv( floorcolour, 0 );
            gl.glMaterialfv( GL.GL_FRONT,GL2.GL_AMBIENT_AND_DIFFUSE, floorcolour, 0 );
            gl.glMaterialfv( GL.GL_FRONT,GL2.GL_SPECULAR, shinycolour, 0 );
            gl.glMateriali( GL.GL_FRONT,GL2.GL_SHININESS, 0 );
